...
export type AnyDispatchPayload =
    ...
    | DispatchPayload<'CHANNEL_SELECT', { channelId: string; jumpType: any; guildId: null | string }>
    | DispatchPayload<'LOAD_MESSAGES_SUCCESS', {}>
    | DispatchPayload<'UPDATE_CHANNEL_DIMENSIONS', { channelId: string; offsetHeight: any; scrollHeight: any; scrollTop: any }>
...
export type MessageStore = {
    getLastMessage(): ClientMessage | undefined;
    getLastEditableMessage(): ClientMessage | undefined;
    getMessage(channelId: string, messageId: string): ClientMessage | undefined;
    getLastCommandMessage(): ClientMessage | undefined;
    focusedMessageId(): string | null;
    getMessages(channelId: string): ChannelMessages;
    hasCurrentUserSentMessage(): boolean;
